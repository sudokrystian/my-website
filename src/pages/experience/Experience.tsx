        ...
        <div className="jobskills-flex">
          <div className="workexp-sections-col">
            <div className="workexp-section">
              <h6>Role & Impact</h6>
              <p>
                I design and build new features for our industry-leading Master
                Data Management platform, while also diving into legacy code to
                ...
                daily toolkit, allowing me to work across both modern and
            ...
            <div className="workexp-section">
              ...
              <p>
                I mentor junior developers, shape solution architectures, and
                bridge communication between backend, DevOps, and deployment
                teams. The work is complex and rewarding—we handle massive
                datasets and push performance to the limit, ensuring our data
                solutions deliver speed and reliability at scale.
                <br />
                With deep dives into JVM internals, memory optimization, and the
                challenges of supporting AI-driven data quality, Stibo Systems
                is a place where learning never stops and every project sharpens
                your technical edge.
              </p>
            </div>
            ...
            <div className="workexp-section">
              ...
              <ul className="job-desc-list">
                ...
                <li>
                  Handling massive datasets, JVM internals, memory optimization,
                  and supporting AI-driven data quality
                </li>
                <li>
        ...
        <div className="jobskills-flex">
          <div className="workexp-sections-col">
            <div className="workexp-section">
              ...
              <p>
                As a part-time Java instructor, I learned as much from my
                students as I taught them. Inexperience doesn’t always mean
                being wrong—fresh perspectives often surprised me and challenged
                my own ways of thinking. It reminded me that even as someone who
                likes to think outside the box, there’s always more room to
                grow.
              </p>
              <p>
                Teaching showed me how important communication is in
                programming. Sometimes, just five extra minutes of explanation
                or a different point of view can save hours of confusion. I
                really enjoyed presenting logical problems and hearing insights
                from students with diverse backgrounds. I encouraged teamwork,
                open-mindedness, and independent projects, and was proud to see
                several students become passionate about game development as a
                result.
              </p>
            </div>
            <div className="workexp-section">
              ...
              <p>
                ...
                learned how different perspectives can either cause conflict or
                lead to unique insights, depending on how you approach them.
                Finding common ground and appreciating individual differences
                has made me a better communicator and teammate.
              </p>
            </div>
          </div>
          <div className="job-skills-images">
            ...
            <img src={react} alt="React" />
            <img src={spring} alt="Spring" />
            <img src={neuralNetwork} alt="Neural Network" />
            <img src={git} alt="git" />
          </div>
        </div>
      </div>
        ...
        <div className="jobskills-flex">
          <div className="workexp-sections-col">
            <div className="workexp-section">
              ...
              <p>
                As a part of the DevOps team, I was responsible for system
                design, maintenance, and support across multiple projects. My
                two key projects—<span className="about-highlight">CBNG</span>{" "}
                and{" "}
            ...
            <div className="workexp-section">
              ...
              <p>
                CBNG is a custom Gradle distribution providing essential tooling
                for developers at CERN. It configures projects to match CERN
                conventions and automates deployment to internal servers via
                Gradle tasks. The plugin architecture allows developers to use
                only what they need, keeping projects lightweight and
                maintainable. My version, based on Gradle 7, improved
                modularity, versioning, and documentation workflows, and
                supported both JFrog Artifactory and CERN’s internal systems.
              </p>
            </div>
            ...
            <div className="workexp-section">
              ...
              <p>
                ...
                builds, minimizing downtime and simplifying updates. With
                thousands of dependencies per application, the focus was on
                reliability and speed—leveraging JPA Entity Graph for database
                efficiency. As a frontend, we built an Angular app for live
                alias management by admins.
              </p>
            </div>
          </div>
          <div className="job-skills-images">
          ...
          <div className="workexp-sections-col">
            <div className="workexp-section">
              ...
              <p>
                ...
                development—working with a wide variety of systems and CMSs.
                This was definitely the job where I had to be the most{" "}
            ...
            <div className="workexp-section">
              <h6>Highlights</h6>
              <p>
                Holme Gruppen delivers a huge variety of services, from
                e-commerce shops to financial broker sites and product
                comparison platforms. The work required a high level of{" "}
                <span className="about-highlight">adaptability</span>—sometimes
                I had to learn a new framework or language in hours to resolve
                urgent issues.
              </p>
              <p>
                All sites were live revenue generators, so any downtime meant
                lost profits. This created a high-pressure environment where I
                learned to stay cool and solve problems in a calm, organized
                way.
              </p>
            </div>
          </div>
